...
const locationSuggestions = [{ id: 1, name: "Current Location" }];
        ...
        <div className="main-navbar-content">
          ...
          <div className="main-navbar-searchbars">
                  ...
                  {dropdownSuggestions.map((item) => (
                    ...
                    >
                      ...
                      <div className="main-navbar-search-info">
                        <span className="main-navbar-search-restaurant">
                          {item.name}
                        </span>
            ...
            <div style={{ position: "relative", flex: 1 }}>
              ...
              {locationDropdownOpen && (
                <div
                  className="main-navbar-location-search-dropdown"
          ...
          <div className="main-navbar-actions">
            ...
            <button
              className="main-navbar-action-btn bell-btn"
